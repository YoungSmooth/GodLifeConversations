...
const colorizeColors = [ColorManager.black, ColorManager.grey, ColorManager.white, ColorManager.purple];
...
final colorizeTextStyle = TextStyle(
  ...
  shadows: [
    ...
    Shadow(offset: const Offset(1.0, 1.0), blurRadius: 8, color: ColorManager.greyS100),
  ],
);
...
const colorizeTextStyleMobile = TextStyle(
  ...
  shadows: [
    Shadow(offset: Offset(2.0, 2.0), blurRadius: 2, color: ColorManager.white10),
